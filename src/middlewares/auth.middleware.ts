...
export const verifyJWT = asyncHandler(async(req:IGetUserAuthInfoRequest,res:Response,next:NextFunction)=>{
...
const user  = await User.findById(decodedObject._id).select("-password -refreshToken");
